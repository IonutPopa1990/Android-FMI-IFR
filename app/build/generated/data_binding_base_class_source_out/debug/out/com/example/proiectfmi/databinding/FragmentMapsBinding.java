...
public final class FragmentMapsBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textMaps;

  private FragmentMapsBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textMaps) {
  ...
  public static FragmentMapsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.text_maps;
      TextView textMaps = rootView.findViewById(id);
      if (textMaps == null) {
        break missingId;
      }

      return new FragmentMapsBinding((ConstraintLayout) rootView, textMaps);
    }
